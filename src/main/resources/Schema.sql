...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `workshop3` ;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`account` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`klant` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`adres` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`artikel` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`bestelling` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workshop3`.`bestelregel` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
